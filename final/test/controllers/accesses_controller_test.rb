...
class AccessesControllerTest < ActionController::TestCase
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post :create, access: { event_id: @access.event_id, track_id: @access.track_id, user_id: @access.user_id }
    end
  ...
  test "should update access" do
    patch :update, id: @access, access: { event_id: @access.event_id, track_id: @access.track_id, user_id: @access.user_id }
    assert_redirected_to access_path(assigns(:access))
  end
